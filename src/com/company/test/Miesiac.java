...
public class Miesiac {
    ...
    Miesiac()
    {
        ...
        nastepny = new JButton("Nastepny miesiąc");
        wybierz = new JLabel("<html> Wybierz datę <br><br></html>");
        wybierz.setFont(new Font("Serif", Font.PLAIN, 40));


        button1=new JButton("29.08");button2=new JButton("30.08");button3=new JButton("31.08");button4=new JButton("01.09");button5=new JButton("02.09");
        button6=new JButton("03.09");button7=new JButton("04.09");button8=new JButton("05.09");button9=new JButton("06.09");button10=new JButton("07.09");
        button11=new JButton("08.09");button12=new JButton("09.09");button13=new JButton("10.09");button14=new JButton("11.09");button15=new JButton("12.09");
        button16=new JButton("13.09");button17=new JButton("14.09");button18=new JButton("15.09");button19=new JButton("16.09");button20=new JButton("17.09");
        button21=new JButton("18.09");button22=new JButton("19.09");button23=new JButton("20.09");button24=new JButton("21.09");button25=new JButton("22.09");
        button26=new JButton("23.09");button27=new JButton("24.09");button28=new JButton("25.09");button29=new JButton("26.09");button30=new JButton("27.09");
        button31=new JButton("28.09");button32=new JButton("29.09");button33=new JButton("30.09");button34=new JButton("01.10");button35=new JButton("02.10");
        ...
        nastepny.setBounds(670,100,200,30);
        ...
        nastepny.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Miesiackolejny miesiackolejny = new Miesiackolejny();
                //Main_Panel.add(new JScrollPane(biblioteka.frame), "2");
                Main_Panel.add(miesiackolejny.panel, "10");
                CLayout.show(Main_Panel, "10");
            }
        });
